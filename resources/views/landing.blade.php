...
<body class="bg-slate-950 text-slate-900 antialiased selection:bg-indigo-200/60">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide lp-slide relative" data-nav-dark>
                ...
                <div class="lp-content lp-hero relative z-10 w-full max-w-3xl px-6 py-24 text-center text-white">
                    ...
                    <div class="mt-7 flex flex-col items-center justify-center gap-3 sm:flex-row">
                        ...
                        @endif
                        <a href="https://wa.me/6281265558044?text={{ rawurlencode('Halo, saya ingin lihat demo Mooda POS.') }}" target="_blank" rel="noopener" class="inline-flex items-center gap-2 rounded-xl border border-white/30 bg-white/10 px-7 py-3.5 text-base font-semibold text-white backdrop-blur transition hover:bg-white/20">{{ sc('landing','hero_cta_demo','Lihat Demo Via WA') }}</a>
                    </div>
            ...
            <div id="fitur" class="swiper-slide lp-slide relative bg-white">
                <div class="lp-content w-full px-6 py-20" style="max-width:1440px;">
                    {{-- Banner promosi Program Affiliate --}}
                    <a href="https://affiliate.mooda.id" target="_blank" rel="noopener"
                       class="group relative mb-10 flex flex-col items-center gap-4 overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-600 via-indigo-600 to-emerald-500 px-6 py-5 text-white shadow-xl shadow-indigo-500/20 sm:flex-row sm:justify-between sm:px-8">
                        <span class="pointer-events-none absolute -right-8 -top-10 h-40 w-40 rounded-full bg-white/10"></span>
                        <span class="pointer-events-none absolute -bottom-12 left-1/3 h-32 w-32 rounded-full bg-white/10"></span>
                        <div class="relative flex items-center gap-4 text-center sm:text-left">
                            <span class="hidden h-12 w-12 flex-shrink-0 place-items-center rounded-xl bg-white/15 text-2xl sm:grid">💸</span>
                            <div>
                                <div class="text-base font-extrabold sm:text-lg">{{ sc('landing','affiliate_banner_judul','Punya jaringan usaha? Jadi Affiliate Mooda!') }}</div>
                                <div class="text-sm text-indigo-100">{{ sc('landing','affiliate_banner_sub','Bagikan link referral & dapat komisi untuk setiap bisnis yang bergabung.') }}</div>
                            </div>
                        </div>
                        <span class="relative inline-flex flex-shrink-0 items-center gap-2 rounded-xl bg-white px-5 py-2.5 text-sm font-bold text-indigo-700 shadow-lg transition group-hover:gap-3 group-hover:bg-indigo-50">
                ...
                <div class="lp-content w-full max-w-6xl px-6 py-14">
                    ...
                    <div class="mooda-price-shell mt-6">
                        @php
                            ...
                            $waCustom = 'https://wa.me/6281265558044?text=' . rawurlencode('Halo, saya tertarik dengan paket Customize Mooda (kontrak 2 tahun). Boleh info fitur & harga rekomendasinya?');
                            $customFeatures = [
                ...
                <div class="mf-wrap" style="padding-top:48px;">
                    <div class="mf-cta-card">
                        ...
                        <div class="mf-cta-actions">
                            ...
                            @endif
                            <a href="https://wa.me/6281265558044?text={{ rawurlencode('Halo, saya ingin tanya tentang Mooda POS') }}" target="_blank" rel="noopener" class="mf-btn mf-btn-ghost">{{ sc('landing','cta_tombol_kontak','Hubungi Kami') }}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="mf-wrap mf-foot">
                    <div class="mf-foot-grid">
                        ...
                        <div class="mf-col">
                            ...
                            <a href="https://wa.me/6281265558044" target="_blank" rel="noopener">{{ sc('landing','footer_kontak_nomor','0812-6555-8044') }}</a>
                        </div>
                        <div class="mf-col">
    ...
    <div class="lp-fab">
        ...
        <a class="lp-fab-contact" href="{{ 'https://wa.me/6281265558044?text=' . rawurlencode('Halo, saya tertarik dengan aplikasi POS Mooda ini') }}" target="_blank" rel="noopener">
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
