        ...
        <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10">
            ...
            <div id="navMobile" class="hidden lg:hidden pb-4">
                <div class="flex flex-col gap-1 text-sm font-semibold text-slate-700">
                    ...
                    @endforeach
                    <a href="https://mooda.id" class="mt-2 text-center bg-indigo-600 text-white rounded-xl px-4 py-2.5">Langganan</a>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 py-14">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                <div class="sm:col-span-2 lg:col-span-1">
                    ...
                    <p class="text-sm leading-relaxed text-slate-400 mb-5">Wawasan & tips praktis mengembangkan bisnis Anda di era digital — dari operasional sampai memilih produk digital yang tepat.</p>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-sm">
                        ...
                        <li class="flex items-center gap-2"><span>🌐</span><a href="https://blog.mooda.id" class="hover:text-indigo-400 transition">blog.mooda.id</a></li>
                    </ul>
                </div>
            </div>
        </div>
